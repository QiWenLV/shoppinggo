...
<body ng-app="shopinggo" ng-controller="itemController" ng-init="num=1;loadSku()">
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
							 <#if (imageList?size>0)>
							     <img jqimg="${imageList[0].imageUrl}" src="${imageList[0].imageUrl}" width="400px" height="400px" />
							 </#if>
							</span>
						</div>
						<!--下方的缩略图-->
								...
								<ul>
									<#if (imageList?size>0)>
									   <#list imageList as item>
										  <li><img src="${item.imageUrl}" bimg="${item.imageUrl}" onmousemove="preview(this)" /></li>
									   </#list>
									</#if>
								</ul>
							</div>
